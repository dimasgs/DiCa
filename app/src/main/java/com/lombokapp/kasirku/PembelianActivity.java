        ...
        fbadd.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(sp.getInt("write_pembelian",0)==1) {
                    ...
                    Toast.makeText(PembelianActivity.this, "Proses Ditolak, Anda tidak memiliki akses", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
    ...
    public class PembelianAdapter extends RecyclerView.Adapter {
        ...
        public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, final int position) {
            if(holder instanceof Holder){
                ...
                h.lfaktur.setText("No. Faktur : "+model.get(position).getNo_faktur());
                h.ldesk.setText(model.get(position).getDeskripsi());
                h.ljumlah.setText("Jumlah : "+nf.format(model.get(position).getTotal_pembelian()));
                            ...
                            public boolean onMenuItemClick(MenuItem item) {
                                switch (item.getItemId()){
                                    ...
                                    case R.id.mhapus:
                                        ...
                                        adb.setMessage("Yakin ingin menghapus "+model.get(position).getKode_pembelian_master()+" ? ");
