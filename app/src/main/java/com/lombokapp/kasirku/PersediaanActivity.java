...
public class PersediaanActivity extends AppCompatActivity {
        ...
        rvdata.addOnScrollListener(new EndlessScroll() {
            ...
            public void onLoadMore() {
                if (svdata.getQuery() == null || (svdata.getQuery().toString().equals(""))) {
                    Toast.makeText(PersediaanActivity.this, "memuat data", Toast.LENGTH_SHORT).show();
                    loaddata();
    ...
    public class PersediaanAdapter extends RecyclerView.Adapter {
        ...
        public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
            ...
            View v = lin.inflate(R.layout.adapter_persediaan, parent, false);
            return new Holder(v);
        }
...
//                                            Toast.makeText(ct, "Bukan Barang Racikan", Toast.LENGTH_SHORT).show();
//                                        }else{
