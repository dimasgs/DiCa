        ...
        rvdata.addOnScrollListener(new EndlessScroll() {
            ...
            public void onLoadMore() {
                if(svdata.getQuery()==null || (svdata.getQuery().toString().equals(""))){
                    Toast.makeText(PenjualanActivity.this, "memuat data", Toast.LENGTH_SHORT).show();
                    loaddata();
            ...
            public void run() {
                ...
                try {
                    String query="SELECT kode_penjualan_master,tanggal_penjualan,status,deskripsi," +
                            "(SELECT SUM(pjd.jumlah*(pjd.harga_jual-(pjd.harga_jual*(pjd.diskon/100)))) " +
                            ...
                            public boolean onMenuItemClick(MenuItem item) {
                                switch (item.getItemId()){
                                    ...
                                    case R.id.mhapus:
                                        ...
                                        adb.setMessage("Yakin ingin menghapus "+model.get(position).getKode_penjualan_master()+" ? ");
