...
//        }
            ...
            lkode_trans.setText("Kode Barang");
            ljumlah.setVisibility(View.GONE);
            lharga.setText("Jumlah");
            ljudul.setText("Laporan Stok Persediaan");
            ...
            ljumlah.setVisibility(View.GONE);
            lharga.setText("Jumlah");
            ljudul.setText("Ranking Penjualan Barang");
            ltotal.setVisibility(View.INVISIBLE);
            lhtotal.setVisibility(View.INVISIBLE);
        }
        loadreport();
                ...
                try {
                    ...
                    if (tipe.equals("penjualan")) {
                        query = "SELECT pjd.kode_penjualan_master,pjm.tanggal_penjualan,pjd.kode_barang,ps.nama_barang,pjd.jumlah,pjd.harga_jual,pjd.diskon," +
                                ...
                                "ORDER BY pjm.date_created DESC";
                        Cursor c = db.rawQuery(query, null);
                        sb.append("Tanggal Transaksi,Kode Transaksi,Kode Barang,Nama Barang,Jumlah Terjual,Harga Jual Asli,Diskon,Harga Diskon,Total Penjualan");
                        sb.append("\n");
                        while (c.moveToNext()) {
                        ...
                        Cursor c = db.rawQuery(query, null);
                        sb.append("Tanggal Transaksi,Kode Transaksi,Kode Barang,Nama Barang,Jumlah Beli,Harga Beli,Total Pembelian");
                        sb.append("\n");
                        while (c.moveToNext()) {
                            sb.append("" + c.getString(1) + "," + c.getString(0) + ",C:" + c.getString(2) + "," +
                                    "" + c.getString(3) + "," + c.getDouble(4) + "," + c.getDouble(5) + "," +
                        ...
                        Cursor c = db.rawQuery(query, null);
                        sb.append("Kode Barang,Nama Barang,Jumlah,Satuan");
                        sb.append("\n");
                        while (c.moveToNext()) {
